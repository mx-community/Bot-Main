...
let verifyaleatorio = ['registrar', 'reg', 'verificar', 'verify', 'register'].getRandom()
 const msg = {
rowner: `📍  Lo siento, el comando *#${comando}* solo puede ser utilizado por el propietario del bot.`,
owner: `📍  Lo siento, el comando *#${comando}* solo puede ser utilizado por los administradores del bot.`,
mods: ` 📍  Lo siento, el comando *#${comando}* solo puede ser utilizado por los usuarios moderadores del bot.`,
premium: `📍  Lo siento, el comando *#${comando}* solo puede ser utilizado por los usuarios premium del bot.`,
group: `📍  El comando *#${comando}* solo puede ser utilizado en chats grupales.\n- Puedes usar el bot en el chat principal o un grupo donde este alojado.`,
private: `📍  El comando *#${comando}* solo puede ser utilizado en chats individuales.\n- Ve al chat individual del bot para utilizar el comando.`,
admin: ` 📍  El comando *#${comando}* solo puede ser utilizado por los administradores grupales.\n- Pidele a un administrador que ejecute el comando si es importante.`,
botAdmin: `📍  El comando *#${comando}* solo puede ser ejecutado si el bot es administrador del grupo.\n- No puede usar funciones las cuales son exclusivas para los administradores.`,
