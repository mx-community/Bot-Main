...
import { alanJsWa } from './plugins/sockets-serbot.js'
...
const qrOption = chalk.greenBright
const textOption = chalk.green
...
console.log(chalk.green.bold(`📍  Escanea este código QR, expira en 40 segundos...`))}
}
if (connection === "open") {
...
alanJsWa({alanJsPath: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}}}}
